 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://web/", wsdlLocation = "http://cc202-10:8080/NewsApp-war/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://web/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://cc202-10:8080/NewsApp-war/NewWebService?wsdl");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://web/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://web/", "NewWebServicePort"), NewWebService.class, features);
    }
