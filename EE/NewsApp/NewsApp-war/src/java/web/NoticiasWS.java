...
public class NoticiasWS {
    ...
    public String altaNoticia(@WebParam(name = "parameter") String titulo, @WebParam(name = "noticia") String noticia) {
        String strRes = null;
        ...
        if ((title!=null) && (body!=null)) 
        {
          try 
          {
            ...
            connection.close();
            strRes = "Dada de alta la noticia: " + titulo + " " + noticia;
           } catch (JMSException ex) 
           {
             ex.printStackTrace();
             strRes = "No hubo noticias";
           }
        }
